...
export class MiPerfilContraseniaNewPassNoCoinciden extends BasePage {
    ...
    async fillContrasenias(): Promise<void> {
        ...
        // await this.page.getByPlaceholder('Entre 8 y 15 caracteres, usar mayúsculas, letras y números.').fill( 'NewPassword0123456789')
        // console.log(this.page.getByPlaceholder('Entre 8 y 15 caracteres, usar mayúsculas, letras y números.').fill( 'NewPassword0123456789'))
    ...
    // page.getByPlaceholder().fill('1234567899Aser469815788')
    async navigateToMiPerfilContraseniaNewPassNoCoinciden(): Promise<void> {
