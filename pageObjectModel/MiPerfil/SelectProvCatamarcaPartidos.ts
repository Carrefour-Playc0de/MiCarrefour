...
export class SelectProvCatamarcaPartidos extends BasePage {
    ...
    constructor(page: Page, context: BrowserContext, environment: string) {
        ...
        this.PROVINCIA = this.page.locator('span').filter({ hasText: 'CATAMARCA' })
    ...
    async clickPartidos (): Promise<void> {
        ...
        const partidosArray = ['AMBATO', 'ANCASTI', 'ANDALGALÁ', 'ANTOFAGASTA DE LA SIERRA', 'BELÉN', 'CAPAYÁN', 'CATAMARCA (CAPITAL)', 'EL ALTO', 'FRAY MAMERTO ESQUIÚ', 'GUASAYÁN', 'LA PAZ', 'PACLIN', 'POMÁN', 'SANTA MARÍA', 'SANTA ROSA', 'TINOGASTA', 'VALLE VIEJO']
        let flag = true
    ...
    async navigateToMiPerfilEditMisDirecProvCatamarcaPartidos(): Promise<void> {
