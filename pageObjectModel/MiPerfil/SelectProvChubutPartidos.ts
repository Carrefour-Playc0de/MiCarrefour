...
export class SelectProvChubutPartidos extends BasePage {
    ...
    constructor(page: Page, context: BrowserContext, environment: string) {
        ...
        this.PROVINCIA = this.page.locator('span').filter({ hasText: 'CHUBUT' })
    ...
    async clickPartidos (): Promise<void> {
        ...
        const partidosArray = ['BIEDMA', 'CUSHAMEN', 'FLORENTINO AMEGHINO', 'FUTALEUFÚ', 'GAIMAN', 'GASTRE', 'LANGUINEO', 'MÁRTIRES', 'PASO DE INDIOS', 'RAWSON', 'RÍO SENGUER', 'SARMIENTO','TEHUELCHES', 'TELSEN']
        let flag = true
    ...
    async navigateToMiPerfilEditMisDirecProvChubutPartidos(): Promise<void> {
