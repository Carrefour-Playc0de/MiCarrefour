...
export class SelectProvJujuyPartidos extends BasePage {
    ...
    constructor(page: Page, context: BrowserContext, environment: string) {
        ...
        this.PROVINCIA = this.page.locator('span').filter({ hasText: 'JUJUY' })
    ...
    async clickPartidos (): Promise<void> {
        ...
        const partidosArray = ['COCHINOCA', 'EL CARMEN', 'HUMAHUACA', 'JUJUY (CAPITAL)', 'LEDESMA', 'LOS ANDES', 'PALPALÁ', 'RINCONADA', 'SAN ANTONIO', 'SAN PEDRO', 'SANTA BÁRBARA', 'SANTA CATALINA', 'SUSQUES', 'TILCARA', 'TUMBAYA', 'VALLE GRANDE', 'YAVI']
        let flag = true
    ...
    async navigateToMiPerfilEditMisDirecProvJujuyPartidos(): Promise<void> {
