...
export class SelectProvMisionesPartidos extends BasePage {
    ...
    constructor(page: Page, context: BrowserContext, environment: string) {
        ...
        this.PROVINCIA = this.page.locator('span').filter({ hasText: 'MISIONES' })
    ...
    async clickPartidos (): Promise<void> {
        ...
        const partidosArray = ['25 DE MAYO', 'APÓSTOLES', 'CAINGUAS', 'CANDELARIA', 'CONCEPCIÓN', 'ELDORADO', 'GENERAL MANUEL BELGRANO', 'GUARANÍ', 'IGUAZÚ', 'LEANDRO N. ALEM', 'LIBERTADOR GENERAL SAN MARTÍN', 'MONTECARLO', 'OBERÁ', 'POSADAS CAPITAL', 'SAN IGNACIO', 'SAN JAVIER', 'SAN PEDRO']
        let flag = true
    ...
    async navigateToMiPerfilEditMisDirecProvMisionesPartidos(): Promise<void> {
