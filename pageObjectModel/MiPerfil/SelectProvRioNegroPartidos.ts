...
export class SelectProvRioNegroPartidos extends BasePage {
    ...
    constructor(page: Page, context: BrowserContext, environment: string) {
        ...
        this.PROVINCIA = this.page.locator('span').filter({ hasText: 'RIO NEGRO' })
    ...
    async clickPartidos (): Promise<void> {
        ...
        const partidosArray = ['25 DE MAYO', '9 DE JULIO', 'ADOLFO ALSINA', 'AVELLANEDA', 'BARILOCHE', 'CONESA', 'EL CUY', 'GENERAL ROCA', 'NORQUINCO', 'PICHI MAHUIDA', 'PILCANIYEU', 'SAN ANTONIO', 'VALCHETA']
        let flag = true
    ...
    async navigateToMiPerfilEditMisDirecProvRioNegroPartidos(): Promise<void> {
