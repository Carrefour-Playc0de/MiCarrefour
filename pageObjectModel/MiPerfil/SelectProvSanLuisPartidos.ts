...
export class SelectProvSanLuisPartidos extends BasePage {
    ...
    constructor(page: Page, context: BrowserContext, environment: string) {
        ...
        this.PROVINCIA = this.page.locator('span').filter({ hasText: 'SAN LUIS' })
    ...
    async clickPartidos (): Promise<void> {
        ...
        const partidosArray = ['AYACUCHO', 'BELGRANO', 'CHACABUCO', 'CORONEL PRINGLES', 'GENERAL PEDERNERA', 'GOBERNADOR DUPUY', 'JUNÍN', 'LIBERTADOR GENERAL SAN MARTÍN', 'SAN LUIS (CAPITAL)']
        let flag = true
    ...
    async navigateToMiPerfilEditMisDirecProvSanLuisPartidos(): Promise<void> {
