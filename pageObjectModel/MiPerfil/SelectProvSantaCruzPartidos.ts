...
export class SelectProvSantaCruzPartidos extends BasePage {
    ...
    constructor(page: Page, context: BrowserContext, environment: string) {
        ...
        this.PROVINCIA = this.page.locator('span').filter({ hasText: 'SANTA CRUZ' })
    ...
    async clickPartidos (): Promise<void> {
        ...
        const partidosArray = ['CORPEN AIKE', 'DESEADO', 'GER AIKE', 'LAGO ARGENTINO', 'LAGO BUENOS AIRES', 'MAGALLANES', 'RÍO CHICO']
        let flag = true
    ...
    async navigateToMiPerfilEditMisDirecProvSantaCruzPartidos(): Promise<void> {
