...
export class SelectProvTucumanPartidos extends BasePage {
    ...
    constructor(page: Page, context: BrowserContext, environment: string) {
        ...
        this.PROVINCIA = this.page.locator('span').filter({ hasText: 'TUCUMAN' })
    ...
    async clickPartidos (): Promise<void> {
        ...
        const partidosArray = ['ALBERDI', 'BURRUYACU', 'CHICLIGASTA', 'CRUZ ALTA', 'FAMAILLÁ', 'GRANEROS', 'LA COCHA', 'LEALES', 'LULES', 'MONTEROS', 'RÍO CHICO', 'SIMOCA', 'TAFÍ DEL VALLE', 'TAFÍ VIEJO', 'TRANCAS', 'TUCUMAN CAPITAL', 'YERBA BUENA']
        let flag = true
    ...
    async navigateToMiPerfilEditMisDirecProvTucumanPartidos(): Promise<void> {
