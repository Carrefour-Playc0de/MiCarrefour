...
test('@qaz @Perfil @Regression (FC-TC-28) Verificar que el selec Provincia CAPITAL FEDERAL y todos sus Partidos funcionan correctamente en Vivis en Barrio Cerrado (SI)', async ({ selectProvCapitalFederalPartidos }) => {
...
test('@qaz @Perfil @Regression (FC-TC-30) Verificar que el selec Provincia CHACO y todos sus Partidos funcionan correctamente en Vivis en Barrio Cerrado (SI)', async ({ selectProvChacoPartidos }) => {
...
test('@qaz @Perfil @Regression (FC-TC-34) Verificar que el selec Provincia ENTRE RIOS y todos sus Partidos funcionan correctamente en Vivis en Barrio Cerrado (SI)', async ({ selectProvEntreRiosPartidos }) => {
...
test('@qaz @Perfil @Regression (FC-TC-35) Verificar que el selec Provincia FORMOSA y todos sus Partidos funcionan correctamente en Vivis en Barrio Cerrado (SI)', async ({ selectProvFormosaPartidos }) => {
...
test('@qaz @Perfil @Regression (FC-TC-36) Verificar que el selec Provincia ISLAS MALVINAS y todos sus Partidos funcionan correctamente en Vivis en Barrio Cerrado (SI)', async ({ selectProvIslasMalvinasPartidos }) => {
...
test('@qaz @Perfil @Regression (FC-TC-37) Verificar que el selec Provincia JUJUY y todos sus Partidos funcionan correctamente en Vivis en Barrio Cerrado (SI)', async ({ selectProvJujuyPartidos }) => {
...
test('@qaz @Perfil @Regression (FC-TC-38) Verificar que el selec Provincia LA PAMPA y todos sus Partidos funcionan correctamente en Vivis en Barrio Cerrado (SI)', async ({ selectProvLaPampaPartidos }) => {
...
test('@qaz @Perfil @Regression (FC-TC-39) Verificar que el selec Provincia LA RIOJA y todos sus Partidos funcionan correctamente en Vivis en Barrio Cerrado (SI)', async ({ selectProvLaRiojaPartidos }) => {
...
test('@qaz @Perfil @Regression (FC-TC-40) Verificar que el selec Provincia MENDOZA y todos sus Partidos funcionan correctamente en Vivis en Barrio Cerrado (SI)', async ({ selectProvMendozaPartidos }) => {
...
test('@qaz @Perfil @Regression (FC-TC-41) Verificar que el selec Provincia MISIONES y todos sus Partidos funcionan correctamente en Vivis en Barrio Cerrado (SI)', async ({ selectProvMisionesPartidos }) => {
...
test('@qaz @Perfil @Regression (FC-TC-42) Verificar que el selec Provincia NEUQUEN y todos sus Partidos funcionan correctamente en Vivis en Barrio Cerrado (SI)', async ({ selectProvNeuquenPartidos }) => {
...
test('@qaz @Perfil @Regression (FC-TC-43) Verificar que el selec Provincia RIO NEGRO y todos sus Partidos funcionan correctamente en Vivis en Barrio Cerrado (SI)', async ({ selectProvRioNegroPartidos }) => {
...
test('@qaz @Perfil @Regression (FC-TC-44) Verificar que el selec Provincia SALTA y todos sus Partidos funcionan correctamente en Vivis en Barrio Cerrado (SI)', async ({ selectProvSaltaPartidos }) => {
...
test('@qaz @Perfil @Regression (FC-TC-45) Verificar que el selec Provincia SAN JUAN y todos sus Partidos funcionan correctamente en Vivis en Barrio Cerrado (SI)', async ({ selectProvSanJuanPartidos }) => {
...
test('@qaz @Perfil @Regression (FC-TC-46) Verificar que el selec Provincia SAN JUAN y todos sus Partidos funcionan correctamente en Vivis en Barrio Cerrado (SI)', async ({ selectProvSanLuisPartidos }) => {
...
test('@qaz @Perfil @Regression (FC-TC-47) Verificar que el selec Provincia SANTA CRUZ y todos sus Partidos funcionan correctamente en Vivis en Barrio Cerrado (SI)', async ({ selectProvSantaCruzPartidos }) => {
...
test('@qaz @Perfil @Regression (FC-TC-48) Verificar que el selec Provincia SANTA FE y todos sus Partidos funcionan correctamente en Vivis en Barrio Cerrado (SI)', async ({ selectProvSantaFePartidos }) => {
...
test('@qaz @Perfil @Regression (FC-TC-49) Verificar que el selec Provincia SANTIAGO DEL ESTERO y todos sus Partidos funcionan correctamente en Vivis en Barrio Cerrado (SI)', async ({ selectProvSantiagoDelEsteroPartidos }) => {
...
test('@qaz @Perfil @Regression (FC-TC-50) Verificar que el selec Provincia TIERRA DEL FUEGO y todos sus Partidos funcionan correctamente en Vivis en Barrio Cerrado (SI)', async ({ selectProvTierraDelFuegoPartidos }) => {
...
test('@qaz @Perfil @Regression (FC-TC-51) Verificar que el selec Provincia TUCUMAN y todos sus Partidos funcionan correctamente en Vivis en Barrio Cerrado (SI)', async ({ selectProvTucumanPartidos }) => {
